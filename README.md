...
It is on the Free server. Free Server spin down with inactivity.
...
```bash
https://github.com/luckyIITR/smoke_detection
```
...
## 3. Create ECR repo to store/save docker image
    - Save the URI: 169523520935.dkr.ecr.eu-north-1.amazonaws.com/smoke_detection
